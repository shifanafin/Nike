...
const CartSlice = createSlice({
    ...
    reducers : {
        ...
        setRemoveItemsFromCart : (state,action)=>{
            const removeItem = cart.cartItem.filter(item=>item.id !==action.payload.id)
            state.cartItem = removeItem
            localStorage.setItem('cart,JSON.stringify(state.cartIt')
...
export const  {setCloseCart,setOpenCart,setAddItemsToCart} = CartSlice.actions;
