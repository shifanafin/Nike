...
const CartSlice = createSlice({
    ...
    reducers : {
        ...
        setGetTotalAmount : (state,action)=>{
         ...
         let {cartTotalAmount,cartTotalQuatity}  = state.cartItem.reduce((cartTotal,cartItem)=>{
            const {price,cartQuality} = cartItem;
            const totalPrice =price * cartQuality
            cartTotal.cartTotalAmount +=  totalPrice
            cartTotal.cartTotalQuatity +=cartQuality
            return cartTotal
