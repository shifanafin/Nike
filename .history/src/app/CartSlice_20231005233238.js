    ...
    reducers : {
        ...
        setGetTotalAmount : (state,action)=>{
         ...
         let {TotalAmount,TotalQuatity}  = state.cartItem.reduce((cartTotal,cartItem)=>{
            ...
            state.cartTotalQuatity = TotalQuatity
        }
...
export const  {setCloseCart,setOpenCart,setAddItemsToCart,setRemoveItemsFromCart,setincrement,setdecrement,setClearCart,setGetTotalAmount} = CartSlice.actions;
export const selectCartstate = (state) =>state.cart.cartState
export const selectCartItems = (state)=>state.cart.cartItem
export const cartTotalAmount = (state)=>state.cart.cartItem
export const cartTotalQuatity = (state)=>state.cart.cartItem
