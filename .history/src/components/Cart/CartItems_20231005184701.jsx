      ...
      <div className='flex items-center gap-5' >
        ...
        <div className='grid items-center'>
          ...
          <div className='flex items-center justify-center gap-5'>
            <button type='button' className='w-5 h-5 rounded bg-black text-white lg:w-4 lg:h-4 active:sc'><MinusIcon/></button>
            <div>{cartQuality}</div>
            <button type='button' className='w-5 h-5 rounded bg-black text-white lg:w-4 lg:h-4'><PlusIcon/></button>
          </div>
