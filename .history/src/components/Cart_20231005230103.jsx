...
import {setCloseCart,selectCartstate ,selectCartItems,setClearCart} from "../app/CartSlice.js"
...
const Cart = () => {
  ...
  const setClearCart = useSelector(selectCartItems)
  ...
  return (
    ...
    ${ifCartState ? "opacity-100 visible translate-x-0":"opacity-0 invisible translate-x-8"}`}>
      <div className={`blur-effect-theme h-screen max-w-xl w-full absolute right-0`}>
        <CartCount onCartToggle={onCartToggle} setClearCart={setClearCart}/>
