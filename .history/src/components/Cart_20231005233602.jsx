...
import {setCloseCart,selectCartstate ,selectCartItems,setClearCart,cartTotalAmount,} from "../app/CartSlice.js"
...
const Cart = () => {
  ...
  const cartTotalAmount = useSelector(cartTotalAmount)
  const cartTotalQuatity = useSelector(cartTotalQuatity)
