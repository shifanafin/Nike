...
import {setCloseCart,selectCartstate ,selectCartItems,setClearCart,cartTotalAmount,cartTotalQuatity,setGetTotalAmount} from "../app/CartSlice.js"
  ...
  return (
    ...
    ${ifCartState ? "opacity-100 visible translate-x-0":"opacity-0 invisible translate-x-8"}`}>
      <div className={`blur-effect-theme h-screen max-w-xl w-full absolute right-0`}>
        <CartCount onCartToggle={onCartToggle} onClearCart={onClearCart} totalQuantity={totalQuantity]/>
        ...
        <div >
          ...
          <div className='fixed bottom-0 bg-white pb-4 px-5 grid items-center  gap-y-8 w-full'>
            <div className='flex items-center justify-between '>
              ...
              <h1 className='bg-black rounded text-white w-10 h-6 font-bold  text-center justify-center'>${totalAmount}</h1>
            </div>
